...
# pip install azure-cognitiveservices-speech tts? 설치
# pip install azure-cognitiveservices-vision-computervision 비전설치
# uvicorn app.main:app --reload uvicorn 시동 명령어
