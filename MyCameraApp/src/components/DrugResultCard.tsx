...
export const DrugResultCard = ({
  ...
  const badgeVariant =
    drugInfo.confidence >= 0.9
      ? "default"
      : drugInfo.confidence >= 0.7
      ? "secondary"
      : "destructive";
              ...
              <View style={styles.detailRow}>
                ...
                <View>
                  ...
                  <Text style={styles.detailValue}>
                    {Math.round(drugInfo.confidence * 100)}%
                  </Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  detailToggle: { flexDirection: "row", justifyContent: "center", paddingVertical: 12 },
